...
@protocol ListOfSellerConnectionCompleteDelegate
-(void) finishedListOfSellerConnection;
@end
@interface ListOfSellerConnection : NSObject
{
...
@property (retain, nonatomic) id <ListOfSellerConnectionCompleteDelegate> delegate;
/*
