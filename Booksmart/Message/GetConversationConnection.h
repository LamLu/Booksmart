...
@protocol WsCompleteGetConversationConnection
-(void) finishedGetConversation;
@end

@interface GetConversationConnection : NSObject
{
...
@property (retain, nonatomic) id <WsCompleteGetConversationConnection> delegate;
/*
