...
@implementation RatingPercentConnection
...
{
    NSString* link = [NSString stringWithFormat:@"%@%@", [WTTSingleton sharedManager].serverURL, @"/include_php/getRatingPercent.php"];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if ([receivedData length] != 0)
    {
        ...
        else if([result caseInsensitiveCompare:@"passed"] == NSOrderedSame)
        {
            ...
            [[WTTSingleton sharedManager] setRatingPercentage:ratingPercentage];
            result = nil;
            jsonObject = nil;
    ...
    [delegate finishedRatingPercentageConnection];
...
- (NSString *) parseJSON: (NSData *) data ;
{
    ...
    else
    {
        ...
        result =  @"passed";
        ratingPercentage = [json objectForKey:@"rating"];
